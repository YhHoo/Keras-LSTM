...
print('Input: ', data)
# create a maps
alphabet = 'abcdefghijklmnopqrstuvwxyz '  # the 'space' is also one of the char
...
# So lets say the max component in data_in_int is 30, then it will prepare 31 components
